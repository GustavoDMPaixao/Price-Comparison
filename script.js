/* 
Step 1: Get the value from the input when button is clicked
Step 2: Go to API server and bring the products
Step 3: Show the products on the scree
Step 4: Create the graph with the prices for comparison
*/
...
function displayItems(products) {
    ...
    productList.innerHTML = products.map(product => `
        ...
        <p class="product-store">Store: ${product.seller.nickname}</p>
